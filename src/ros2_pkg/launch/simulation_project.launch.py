...
ros2_pkg_path = get_package_share_directory("ros2_pkg")
simulation_world_file_path = Path(ros2_pkg_path, "worlds/simulation_project_world.sdf").as_posix()
simulation_models_path = Path(ros2_pkg_path, "models").as_posix()
